...
gt = np.concatenate((
                                  np.load("gt/gt_Video_10_1_1_veterinaria_000051.npy"),\
                                  np.load("gt/gt_Video_10_1_1_veterinaria_000101.npy"),\
                                  ))
...
descriptor_mask = np.concatenate((
                                  np.load("../tensors/train/mask_Video_10_1_1_veterinaria_000051.npy").squeeze(),\
                                  np.load("../tensors/train/mask_Video_10_1_1_veterinaria_000101.npy").squeeze(),\
                                  ))
...
cap = cv2.VideoCapture("../datasets/rrc-text-videos/ch3_train/Video_10_1_1.mp4")
...
#    resized = cv2.resize(gt[i, :].reshape((38, 38)), (int(video_width), int(video_height)), interpolation = cv2.INTER_AREA)  # gt
